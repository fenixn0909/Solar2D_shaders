--[[
  ...
  https://godotshaders.com/shader/animated-tv-static-border-shader/
...
float UPDATE_INTERVAL = CoronaVertexUserData.x;
float STATIC_GRANULARITY = CoronaVertexUserData.y;
float EDGE_BLUR = CoronaVertexUserData.z;
float BORDER_SIZE = CoronaVertexUserData.w;
